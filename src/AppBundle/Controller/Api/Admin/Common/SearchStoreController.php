...
use AppBundle\Entity\IdNameURL;
...
class SearchStoreController extends FOSRestController
{
    ...
    public function getEntitiesAction( Request $request )
    {
        ...
        if( !empty( $name ) )
        {
            ...
            $searchEntities = ['AppBundle\Entity\Common\Person' => 'app_admin_common_person_index',
                'AppBundle\Entity\Client\Client' => 'app_admin_client_client_index'];
